...
public class RedisUtils {
    ...
    public static void setEx(String key, long expireTime, String value, TimeUnit unit) {
    ...
    public static long setNX(String format, int i, String number) {
        System.out.println("setNX");
       return 0;
    }

    public static void get(String key, long l, String s) {
        redisTemplate.opsForValue().get(key, l, Long.parseLong(s));
    }
